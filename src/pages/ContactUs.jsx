  ...
  return (
    <section className='min-h-screen'>
      ...
      <p className="text-gray-300 mb-8">
        I'm <span className="font-bold text-white tracking-wide">Anmol Kumar</span>, a passionate and dedicated professional in the world of
      ...
      <p className="text-gray-300 mb-8 border py-5 px-4 rounded-md">
        ...
        <Link
          to="https://www.linkedin.com/in/your_linkedin_profile"
      ...
      <p className="text-gray-300 mb-8 border py-5 px-4 rounded-md">
        ...
        meaningful together.
        <Link
          to="https://twitter.com/your_twitter_username"
          className="text-blue-400 ml-5 hover:text-blue-200 flex items-center gap-3"
          target="_blank"
          rel="noopener noreferrer"
        >
